...
CREATE TABLE inventario (
    id_producto INT PRIMARY KEY,          -- entero simple: los IDs se cargan a mano, no hace falta autoincremento
    nombre_producto VARCHAR(100),
    categoria VARCHAR(50),
    precio_unitario DECIMAL(10,2),        -- decimal en vez de float, para evitar errores de redondeo en dinero
    stock_actual INT,
    stock_minimo INT,
    fecha_ingreso DATE,                   -- date porque solo se necesita día/mes/año, sin horario
    activo TINYINT                        -- tinyint (1/0) para disponible/descontinuado, ocupando el mínimo espacio
);
